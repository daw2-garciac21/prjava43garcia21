...
public class Prjava43garcia21 extends Frame
...
setTitle("nova finestra prjava43garcia21"); // "this" Frame sets title
setSize(450, 100); // "this" Frame sets initial size
setVisible(true); // "this" Frame shows
}
/** The entry main() method */
public static void main(String[] args) {
new Prjava43garcia21(); // Let the construct do the job
}
/** ActionEvent handler */
@Override
